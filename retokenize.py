...
def align_lists(correct_tokens: List[Text], input_tokens: List[Text]) -> Tuple[TokenAligner, List[Text]]:
    ta = TokenAligner(correct_tokens, input_tokens)
    return ta, correct_tokens
